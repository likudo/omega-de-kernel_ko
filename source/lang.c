...
const char zh_sleep[]="슬립기능";
const char zh_cheat[]="치트";

const char zh_hot_key[]="슬립기능 키";
...
const char zh_no_game_played[]="아무 게임도 플레이하지 않았음";
...
const char zh_save_sav[]="저장하시겠습니까?";
const char zh_save_ing[]="저장중...";
const char zh_save[]="   세이브";
const char zh_auto_save[]="자동 저장";

const char zh_modeB_INITstr[]="    모드B";
const char zh_modeB_RUMBLE[]="럼블";
const char zh_modeB_RAM[]="램";
const char zh_modeB_LINK[]="링크";

const char zh_led[]="      LED";
const char zh_led_open[]="LED 켜기";
const char zh_Breathing_light[]="브리딩효과";
const char zh_SD_working[]="   SD LED";

const char zh_NOR_full[]="NOR이 가득 찼습니다.";
const char zh_save_loaded[]="저장 불러오기 완료";
const char zh_save_saved[]="저장 완료";
const char zh_file_exist[]="덮어쓰시겠습니까?";
const char zh_file_noexist[]="저장파일 없음";
